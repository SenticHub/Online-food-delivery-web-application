   ...
   return (
    <div>
      ...
      <div className="container-fluid fixed-top px-0 wow fadeIn" data-wow-delay="0.1s">
        ...
        {/* Navbar */}
        <nav className="navbar navbar-expand-lg navbar-light bg-white shadow-sm py-lg-0 px-lg-5">
          <Link to="/" className="navbar-brand ms-3 ms-lg-0">
          ...
          <div className="collapse navbar-collapse" id="navbarCollapse">
            <div className="navbar-nav ms-auto p-3 p-lg-0 text-center text-lg-start">
              <Link to="/" className="nav-item nav-link active">Home</Link>
              <Link to="/product" className="nav-item nav-link">Products</Link>
                ...
                <>
                  ...
                  <div className="nav-item dropdown">
                    ...
                    <ul className="dropdown-menu" aria-labelledby="userDropdown">
                      ...
                      <li><a onClick={logout} className="dropdown-item" style={{ cursor: "pointer" }}>Log out</a></li>
                    </ul>
                  </div>
                </>
              )}
